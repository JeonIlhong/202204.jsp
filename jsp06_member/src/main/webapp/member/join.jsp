...
<%@ include file="../header.jsp" %>
	<h2>회원가입</h2>
	<!-- enctype:전송데이터의 타입 -->
	<!-- 파일전송시 : post방식으로 , multipart/form-data  -->
	<form action="${path}/join.member" method="post" enctype="multipart/form-data" name="frmJoin">
		<table>
			<tr>
				<th>아이디</th>
			...
			<tr>
				<td colspan="2" align="center"> 
					<button onclick="joinCheck(event)">등록</button>
